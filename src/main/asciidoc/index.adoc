...
operation::query-events[snippets='response-fields,curl-request,http-response']
...
operation::get-event[snippets='curl-request,http-request,http-response,httpie-request,response-body,response-fields,response-headers,links']
